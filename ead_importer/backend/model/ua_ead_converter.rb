...
# This section of the UA EAD Converter plugin modifies the stock ArchivesSpace EAD Converter
...
# We have either decided against implementing the functionality OR the ArchivesSpace importer has changed,
# deprecating the following customizations
# START IGNORE
