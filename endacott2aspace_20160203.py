...
with open("Endacott_Society_Metadata.csv","rU") as csvFile:
	...
	# print(rep)
	# kill = requests.delete(aspace_url+"/repositories/2",headers=headers).json()
	...
	#
	# end_chil_post=requests.post(aspace_url+"/repositories/2/resources/3/children",headers=headers,data=json.dumps(end_children)).json()
