...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <xsl:template match="/">
            ...
            <eadheader langencoding="iso639-2b" findaidstatus="edited-full-draft" audience="internal">
                ...
                <profiledesc>
                    <creation><xsl:value-of select="//ead:profiledesc/ead:creation"/></creation>
                </profiledesc>
                <revisiondesc>
                    <change>
                        <date><xsl:value-of select="//ead:revisiondesc/ead:change/ead:date"/></date>
                        <item><xsl:value-of select="//ead:revisiondesc/ead:change/ead:item"/></item>
                    </change>
                    ...
                    <archdesc level="collection" type="inventory" relatedencoding="351$c"> 
                        <did> 
                            ...
                            <abstract label="Abstract"><xsl:value-of select="//ead:did/ead:abstract"/></abstract>
                            <physdesc encodinganalog="300$a" label="Physical Description">
                                <extent><xsl:value-of select="//ead:did/ead:physdesc/ead:extent"/></extent>
                            </physdesc>
                            ...
                            <prefercite> 
                                ...
                                <p><xsl:value-of select="//ead:prefercite//ead:p"/></p>
                            </prefercite>
                           <!-- <processinfo>
                                <head>Processing History</head>
                                <p>Processed by <xsl:value-of select="//ead:processinfo//ead:p"/></p>
                            </processinfo>-->
